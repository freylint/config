...
in
{
  ...
  xfce-has-battery-plugin = scenario "xfce-has-battery-plugin" (
    builtins.elem pkgs.xfce4-battery-plugin cfg.environment.systemPackages
  );
  xfce-has-whiskermenu-plugin = scenario "xfce-has-whiskermenu-plugin" (
    builtins.elem pkgs.xfce4-whiskermenu-plugin cfg.environment.systemPackages
  );
}
